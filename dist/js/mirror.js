	...
	mirror:function(obj){		
		...
		Mirror.prototype={ //赋值语句
			...
			createBig:function(e){
				...
				var mirrorDiv = "<div class='div1' style='position:absolute;left:"+mirrorLeft+"px;top:"+mirrorTop+"px;width:"+this.mirrorWidth+"px;height:"+this.mirrorHeight+"px;border:1px solid pink;' ></div>";
				var t = this;
				...
				this.bigBoxDom.style.cssText = "position:absolute;left:"+left1+"px;top:"+top1+"px;width:"+boxBigWidth+"px;height:"+boxBigHeight+"px;overflow:hidden;z-index:999";
				this.bigBoxDom.class="bag";
